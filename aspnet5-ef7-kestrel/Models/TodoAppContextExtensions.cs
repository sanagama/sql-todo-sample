    ...
    public static class TodoAppContextExtensions
    {
        public static void EnsureSeedData(this TodoAppContext context)
        {
            ...
            if (!context.Persons.Any())
            {
                ...
                var joe = context.Persons.Add(new Person {FirstName = "Joseph", LastName = "Idziorek"}).Entity;
                ...
                context.Tasks.AddRange(
                    ...
                    new Task { Title = "write SQLDW blog", DueDate = new DateTime(2016,06,01), Priority = 1, IsComplete = false, Assignment = joe },
                    ...
                    new Task { Title = "ship malmo", DueDate = new DateTime(2016,04,01), Priority = 3, IsComplete = false, Assignment = mohamed }
                );
            }
            context.SaveChanges();
        }
